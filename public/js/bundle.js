...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"notify.js":[function(require,module,exports) {
"use strict";
...
var notify = function notify(msg, type) {
  ...
  if (!type) type = 'error';
  hideNotif();
  var markup = "<div class=\"notify notify--".concat(type, "\">").concat(msg, "</div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _notify.notify)(_context.t0.response.data.message, 'error');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _notify.notify)('Error logging out, please try again.', 'error');
...
},{"axios":"../../node_modules/axios/index.js","./notify":"notify.js"}],"updateSettings.js":[function(require,module,exports) {
/* eslint-disable*/
'use strict';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            endpoint = type === 'password' ? 'updatePassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _notify.notify)("Your ".concat(type, " was updated"), 'success'); //   setTimeout(() => location.reload(true), 2000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./notify":"notify.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hlYmEiLCJhIjoiY2w0bW13cHp0MGY0ZDNicXVpbm5tbDllaCJ9.Vt8NASgQhXHyeInica3BpA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/cheba/cl4mnpcu7004214qsqpra4htq',
    // style URL
    scrollZoom: false,
    focusAfterOpen: false //   center: [-118.114158, 34.119378], // starting position [lng, lat]
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51LF036BDIz4JH8n9pSP6H7w1BG27z5XZ6iTLdeSYNP4ABbWZnoxwYKs1YsbhDjnLYgWGkzY6CmvBt7PWbZabqudE003SH46KtQ'); // publishable key
          ...
          case 9:
            ...
            (0, _notify.notify)('Error processing payment, please try again later.', 'error');
...
},{"axios":"../../node_modules/axios/index.js","./notify":"notify.js"}],"index.js":[function(require,module,exports) {
/* eslint-disable*/
'use strict';
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSettings.updateUserData)(form, 'data');
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              //Clear input fields & change btn back
